...
class DataSet(object):
    def __init__(self, data_path, image_size=128):
        ...
        self.images = np.zeros((len(self.imgList), image_size, image_size, 3)).astype(float) # [11,64,64,3]
        ...
        for i in range(len(self.imgList)):
            ...
            self.images[i] = image
        print('Data loaded, shape: {}'.format(self.images.shape)) # (11,64,64,3)
    ...
    def to_range(self, low_bound, up_bound):
        ...
        range_0_1 = (self.images - min_val) / (max_val - min_val)
        range_0_2 = range_0_1 * (up_bound - low_bound)
        return low_bound + range_0_2
